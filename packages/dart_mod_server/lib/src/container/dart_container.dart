...
///     if (slotIndex == 0) return item.item.id == 'minecraft:diamond';
///     return true;
///   }
/// }
/// ```
...
abstract class DartContainer {
  ...
  ItemStack getItem(int slotIndex) {
    return getContainerItem(menuId, slotIndex);
  }

  /// Set the item in a slot.
  void setItem(int slotIndex, ItemStack item) {
    setContainerItem(menuId, slotIndex, item);
  }
  ...
  int get slotCount => getContainerSlotCount(menuId);
