...
Future<void> main() async {
  ...
  await group('AABB utilities', () async {
    await testMinecraft('AABB.contains works correctly', (game) async {
    ...
    await testMinecraft('AABB.intersects works correctly', (game) async {
    ...
    await testMinecraft('AABB.center returns correct center', (game) async {
      final aabb = AABB(Vec3(0, 0, 0), Vec3(10, 10, 10));
    ...
    await testMinecraft('AABB.expand works correctly', (game) async {
      final aabb = AABB(Vec3(0, 0, 0), Vec3(10, 10, 10));
    ...
    await testMinecraft('AABB.fromCenter creates correct box', (game) async {
    ...
    await testMinecraft('AABB.cube creates correct cube', (game) async {
