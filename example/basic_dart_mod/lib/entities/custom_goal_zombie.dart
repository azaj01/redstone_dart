...
class AggressiveChaseGoal extends CustomGoal {
  AggressiveChaseGoal()
      : super(
          id: 'basic_dart_mod:aggressive_chase',
          priority: 2,
...
class CustomGoalZombie extends CustomMonster {
  CustomGoalZombie()
      : super(
          id: 'basic_dart_mod:custom_goal_zombie',
          settings: MonsterSettings(
            ...
            goals: [
              ...
              CustomGoalRef(priority: 1, goalId: 'basic_dart_mod:spin'),
              CustomGoalRef(priority: 2, goalId: 'basic_dart_mod:aggressive_chase'),
